 ...
 */
final class Version20200426144704 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE contenu_panier (id INT AUTO_INCREMENT NOT NULL, quantit INT NOT NULL, date DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE panier (id INT AUTO_INCREMENT NOT NULL, no_id INT NOT NULL, dateachat DATE NOT NULL, etat TINYINT(1) NOT NULL, INDEX IDX_24CC0DF21A65C546 (no_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, motdepasse VARCHAR(255) NOT NULL, roles VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE panier ADD CONSTRAINT FK_24CC0DF21A65C546 FOREIGN KEY (no_id) REFERENCES contenu_panier (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE panier_users DROP FOREIGN KEY FK_3DAE8A54F77D927C');
        $this->addSql('ALTER TABLE contenu_panier_produit DROP FOREIGN KEY FK_179C43E3F347EFB');
        $this->addSql('ALTER TABLE panier_users DROP FOREIGN KEY FK_3DAE8A5467B3B43D');
